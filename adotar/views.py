...
def processa_pedido_adocao(request, id_pedido):
    ...
    if status == "A":
        pedido.status = 'AP'
        string = 'Olá, seu pedido de adoção foi aprovada com sucesso...'
    elif status == "R":
        pedido.status = 'R'
        string = 'Olá, infelizmente seu pedido foi recusado...'

    pedido.save()

    ############## alterar o status aqui assim que o pet for aceito para adoção ##################
    ...
    messages.add_message(request, constants.SUCCESS, 'Pedido de adoção feito com sucesso.')
